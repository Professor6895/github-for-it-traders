          ...
          <div class="router-content">
            ...
            <div class="content-area__content">
              ...
              <transition :name="routerTransition" mode="out-in">
                <router-view @changeRouteTitle="changeRouteTitle" @setAppClasses="(classesStr) => $emit('setAppClasses', classesStr)" :key="$route.fullPath"/>
              </transition>
            </div>
          </div>
        </div>
...
export default {
  ...
  computed: {
    dash_title() {return _.get(this.$store, 'state.settings.dashboard_settings.core.brand_name', 'JED-CMS') },
