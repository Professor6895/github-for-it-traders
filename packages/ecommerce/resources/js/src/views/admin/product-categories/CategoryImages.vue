  ...
  methods: {
    async fetchImages() {
      ...
      try {
        let response = await this.$http.get(
          `/api/admin/product-categories/${this.category_id}/images`
        );
    ...
    async saveImage() {
      ...
      try {
        ...
        let url = `/api/admin/product-categories/${this.category_id}/images`;
      ...
      this.$vs.dialog({
        ...
        accept: async () => {
          let response = await this.$http.delete(
            `/api/admin/product-categories/${this.category_id}/images/${image_id}`
          );
